...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/starwithtick.png
  AssetGenImage get starwithtick =>
      const AssetGenImage('assets/icons/starwithtick.png');

  /// File path: assets/icons/typing.png
  AssetGenImage get typing => const AssetGenImage('assets/icons/typing.png');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/imagepicker.png
  AssetGenImage get imagepicker =>
      const AssetGenImage('assets/images/imagepicker.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [imagepicker, pic1, pic2];
}

class $AssetsSvgGen {
  const $AssetsSvgGen();

  /// File path: assets/svg/barcode_scan.svg
  SvgGenImage get barcodeScan =>
      const SvgGenImage('assets/svg/barcode_scan.svg');

  /// List of all assets
  List<SvgGenImage> get values => [barcodeScan];
}
